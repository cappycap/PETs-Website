        ...
        {siteEnabled && (<Animated.View style={[styles.mainContainer,{opacity:fadeAnim}]}>
            ...
            {section == 1 && (<View style={styles.section}>
                ...
                <View style = {[styles.infoBox, {borderColor: 'transparent', maxWidth: '50%', margin: 'auto'} ]}>
                    ...
                    <Text style = {[styles.title, { marginTop:20}]}>Pseuonymization techniques you can use</Text>
                    <Text style = {[styles.title, { marginTop:20}]}>Censor your content</Text>
                    ...
                    <Text style = {[styles.title, { marginTop:20}]}>K-anonymity</Text>
