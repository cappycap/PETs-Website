        ...
        {siteEnabled && (<Animated.View style={[styles.mainContainer,{opacity:fadeAnim}]}>
            ...
            {section == 0 && (<View style={styles.section}>
                ...
                <View style = {[styles.infoBox, {borderColor: 'transparent', maxWidth: '50%', margin: 'auto'} ]}>
                    <Text style = {[styles.paragraph]}>Welcome to the first module of our lesson on the basics of encryption! First, we want to to start off with an activity on the most simple cipher, the Caesar cipher.</Text>
            ...
            {section == 1 && (<View style={styles.section}>
                ...
                <View style = {[styles.infoBox, {borderColor: 'transparent', maxWidth: '50%', margin: 'auto'} ]}>
                    ...
                    <Text style = {[styles.paragraph]}></Text>
                    <Text style = {[styles.paragraph, { marginTop:20}]}>The cipher we learned in the previous section did an adequate enough job in ensuring that at a first glance, people would not be able to understand its content. However, a simple caesar cipher is not enough protection for your messages. Our attackers are not people, but the computers that run billions of operations per second. The 26! permutations needed to test for a caesar cipher is trivial.</Text>
                    <Text style = {[styles.title, { marginTop:20}]}>Symmetric Cryptography</Text>
                    <Text style = {[styles.paragraph, { marginBottom:20}]}>Encrypting your message symmetrically can be one such way. Symmetric encryption will require a single key, a string of completely random letters and numbers that will be used as your cipher. This key will jumble your message in a way that can only be decrypted by the other person with the same key, thus symmetry. Already compared to the caesar cipher, depending on the length of your key, an attacker's bruteforce strategy may scare them off!</Text>
